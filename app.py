...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Ngọc Tuyên - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0326097327</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Ngọc Tuyên - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0326097327</div>", unsafe_allow_html=True)
